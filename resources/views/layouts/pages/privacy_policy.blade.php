...
@section('title')Privacy Policy | {{env('APP_NAME')}}@endsection
...
@section('keywords') TopMobileInfo,Privacy Policy,topmobileinfo,phone,cellphone,information,info,list @endsection
@section('content')
            ...
            <div class="col-lg-8">
                <div class="">
                    <div class="totall-product mb-3">
                        ...
                        <h2 class="fs-20"><b>Privacy Policy</b></h2>
                    </div>
                </div>
                <div class="row product-grid-3 ">
                    <div class="col-md-12">
                        {!!optional($settings)->privacy_policy!!}
                    </div>
                </div>
            </div>
