...
@section('title'){{optional($brand_info)->name}} Mobile Price in Bangladesh {{date("Y").' | '. env('APP_NAME')}}@endsection
@section('description'){date("Y")}} latest updated {{optional($brand_info)->name}} ✓Official ✓Unofficial Price List in Bangladesh ✓Full Specifications ✓Rating ✓Review.@endsection
@section('keywords') TopMobileInfo,{{optional($brand_info)->name}},topmobileinfo,phone,cellphone,information,info,list @endsection
@section('content')
                    ...
                    <div class="totall-product mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{optional($brand_info)->name}}</li>
                            </ol>
                        </nav>
                        <h2 class="fs-20"><b>{{optional($brand_info)->name}} Phones</b></h2>
                    </div>
                </div>
