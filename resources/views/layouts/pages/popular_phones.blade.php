...
@section('title')Popular Phones in Bangladesh {{date("Y").' | '. env('APP_NAME')}}@endsection
@section('description'){date("Y")}} latest updated Popular ✓Official ✓Unofficial phone Price List in Bangladesh ✓Full Specifications ✓Rating ✓Review.@endsection
@section('keywords') TopMobileInfo,Popular,topmobileinfo,phone,cellphone,information,info,list @endsection
@section('content')
            ...
            <div class="col-lg-8">
                <div class="">
                    <div class="totall-product mb-3">
                        ...
                        <h2 class="fs-20"><b>Popular Phones</b></h2>
                    </div>
                </div>
