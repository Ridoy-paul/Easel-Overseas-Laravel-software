@php( $new_phones = App\Models\Products::where('is_active', 1)->orderBy('release_date', 'DESC')->take(6)->get(['id', 'title', 'image', 'url', 'brand_id', 'coming_soon_status', 'is_rumored', 'is_discount']))
<div class="widget-category mb-20 p-10">
    <h5 class="section-title style-1 mb-30 wow fadeIn animated">New Phones</h5>
    <div class="row">
        @foreach($new_phones as $product)
        ...
        <div class="col-lg-12 col-md-12 col-12 col-sm-12">
            <div class="mb-3">
                ...
                <a href="{{route('index')}}" title="" class="btn btn-sm rounded-pill">View All</a>
                </div>
            </div>
        </div>
