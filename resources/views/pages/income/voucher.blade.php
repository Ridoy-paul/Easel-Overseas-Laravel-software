                  ...
                  <div class="card-header text-center">
                    ...
                    <div class="row">
                        <div class="col-md-4 text-left">
                            <p class="" style="margin-top: 20px; font-size: 20px; font-weight: bold;">Voucher #OV/{{optional($info)->id}}</p>
                        </div>
                        <div class="col-md-4">
                            <button type="button" style="margin-top: 10px;" class="btn btn-outline-dark"><h5><b>Payment Received Voucher</b></h5></button>
                        </div>
                        <div class="col-md-4">
